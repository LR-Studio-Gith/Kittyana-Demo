...
function bbox_height() {return bbox_bottom-bbox_top} 

/// Returns the exact center of the caller's bounding box on the x-axis.
function bbox_center_x() {return bbox_left + bbox_width()/2}

/// Returns the exact center of the caller's bounding box on the y-axis.
function bbox_center_y() {return bbox_top + bbox_height()/2}
